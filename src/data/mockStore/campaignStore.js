    ...
    // 3. Active / Full Content / High Perf / Poor
    {
      ...
      audienceConfig: {
        ...
        retailers: [
          ...
          "Nordic Design House",
          "Seoul Streetwear",
          "Bond Street Collective",
          "Sydney Harbour Fashion",
          "Toronto Trends",
          "Berlin Modern",
          "Shanghai Chic",
        ],
...
`,
    ...
    // 18. Cartier (Expiring Soon)
    {
      ...
      cover: "bg-red-50",
      audience: "Platinum & Northeast",
      audienceConfig: {
        type: "segment",
        count: 28,
        filters: ["Platinum", "Northeast", "VIP", "Boutique"],
      },
      isPinned: true,
      updatePending: false,
      adoptionRate: 85,
